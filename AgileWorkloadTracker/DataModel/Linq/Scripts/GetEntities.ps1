...
SPMetal.exe /web:http://casmp/sites/a01 /language:csharp /namespace:CAS.AgileWorkloadTracker.DataModel.Linq /parameters:Parameters.xml /code:../Entities.cs| write-host
write-host "Done . "
