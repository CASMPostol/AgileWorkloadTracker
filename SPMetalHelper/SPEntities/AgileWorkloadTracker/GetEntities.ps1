...
SPMetal.exe /web:http://casmp/sites/awt /language:csharp /namespace:CAS.AgileWorkloadTracker.SPEntitie /parameters:Parameters.xml /code:Entities.cs| write-host
write-host "Done . "
