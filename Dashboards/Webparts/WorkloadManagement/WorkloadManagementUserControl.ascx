                ...
                <asp:Panel runat="server" BorderColor="ActiveCaptionText" GroupingText="Workload">
                    <asp:Table ID="m_TableWorkloadData" runat="server" CssClass="TableInside">
                        <asp:TableRow>
                            ...
                            <asp:TableCell>
                                <asp:DropDownList runat="server" ID="m_ProjectDropDown" CssClass="DropDown"></asp:DropDownList>
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                            <asp:TableCell>
                            ...
                            <asp:TableCell>
                                <asp:DropDownList runat="server" ID="m_TaskDropDown" CssClass="DropDown"></asp:DropDownList>
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                            <asp:TableCell>
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell>
                                <asp:DropDownList runat="server" ID="m_WorkloadMinutesDropDown" CssClass="DropDownShort"></asp:DropDownList>
                            </asp:TableCell>
                        </asp:TableRow>
                    </asp:Table>
                </asp:Panel>
